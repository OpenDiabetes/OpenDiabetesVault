 ...
 * @author tiweGH
 */
public class ElevationPointFilterOption extends FilterOption {

    private final double minElevationPerMinute;
    private final VaultEntryType type;
    private final int minutesBetweenEntries;

    public ElevationPointFilterOption(VaultEntryType type, double minElevationPerMinute, int minutesBetweenEntries) {
